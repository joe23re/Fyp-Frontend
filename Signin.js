...
export default function Signup({navigation}){
    ...
    return(
        ...
        <ScrollView>
          ...
          <Text style={{fontFamily:'Outfit_400Regular',fontSize:32,textAlign:'center',padding:60}}>Sign In Now</Text>
          ...
          <View style={{flexDirection:"row",marginLeft:25,paddingTop:15}}>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate("PhoneNumberForForgetPassword")}>
                <Text style={{color:"#0051FF", marginLeft:100}}>Forgot Password?</Text>
            </TouchableOpacity>
          </View>
